/* Content copied from https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v2.5.0/contracts/crowdsale/Crowdsale.sol 
and adapted to solidity 0.6 */
...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    /**
    Change fallback function and adapt it to solidity 0.6: receive function.
     */
